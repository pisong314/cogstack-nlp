    ...
    def load(cls, tokenizer_path: str, relcat_config: ConfigRelCAT, **kwargs
        ...
        if os.path.exists(tokenizer_path):
            if "modern-bert" in cnf_gen.tokenizer_name:
                from medcat2.components.addons.relation_extraction.modernbert.tokenizer import TokenizerWrapperModernBERT  # noqa
                ...
                from medcat2.components.addons.relation_extraction.bert.tokenizer import TokenizerWrapperBERT  # noqa
                tokenizer = TokenizerWrapperBERT.load(
                    tokenizer_path, relcat_config=relcat_config, **kwargs)
            elif "llama" in cnf_gen.tokenizer_name:
                from medcat2.components.addons.relation_extraction.llama.tokenizer import TokenizerWrapperLlama  # noqa
            ...
            from medcat2.components.addons.relation_extraction.bert.tokenizer import TokenizerWrapperBERT  # noqa
            from medcat2.components.addons.relation_extraction.ml_utils import create_tokenizer_pretrain  # noqa
            logger.info(
